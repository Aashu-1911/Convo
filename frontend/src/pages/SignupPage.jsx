      ...
      <div className='flex flex-col lg:flex-row w-full max-w-6xl mx-auto bg-gray-900 rounded-xl shadow-2xl overflow-hidden border border-emerald-500/20'>
        ...
        <div className='w-full lg:w-1/2 p-8 sm:p-12 flex flex-col bg-gray-900 text-white'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-gray-400 text-sm'>Join LangConnect and start your language learning journey</p>
          </div>
          ...
          <form onSubmit={handleSignup} className='flex-1 flex flex-col'>
            ...
            <p className='text-xs text-gray-400 mb-4'>Password must be at least 6 characters long</p>
